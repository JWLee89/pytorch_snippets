...
if __name__ == '__main__':
    ...
    def forward_hook_function(layer: nn.Module, input_tensor: t.Tuple[torch.Tensor, ...], output_tensor: t.Tuple[torch.Tensor, ...]):
        """
        ...
        Args:
            ...
            output_tensor (t.Tuple[torch.Tensor, ...]): The output arguments (in moust cases, a tuple with a single output tensor)
        """
        
        print(f'Current layer: {layer}, input_tensor: {input_tensor}' 
